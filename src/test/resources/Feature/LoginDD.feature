...
@login @validcredentials @smoke @regression @sanity
...
@login @invalidcredentials @smoke @regression @sanity
...
@login @invalidvalidcredentials @regression @sanity
...
@login @validinvalidcredentials @regression @sanity
...
@login @nocredentials @regression @sanity
